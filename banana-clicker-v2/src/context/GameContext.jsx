...
export const ITENS_PRODUCAO = [
  { id: "p1", nome: "Macaquinho Ajudante", emoji: "🐒", preco: 10,  bananasSegundo: 1,  canto: "superior-esquerdo" },
  { id: "p2", nome: "Bananal",             emoji: "🌴", preco: 50,  bananasSegundo: 5,  canto: "inferior-esquerdo" },
  { id: "p3", nome: "Fazenda de Macacos",  emoji: "🏡", preco: 200, bananasSegundo: 20, canto: "superior-direito"   },
  { id: "p4", nome: "Fabrica de Banana",   emoji: "🏭", preco: 500, bananasSegundo: 50, canto: "inferior-direito"   },
];
...
export function GameProvider({ children }) {
  ...
  const valor = {
    bananas, porClique, porSegundo, qtdProducao,
    powerupsComprados, venceu,
    clicarMacaco, precoProducao, comprarProducao, comprarPowerUp, reiniciar,
  };
